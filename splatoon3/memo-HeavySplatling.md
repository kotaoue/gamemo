...
| 状況 | if-then |
| -- | -- |
| プレイ | <ol><li>Scan: チャージ前確認</li><li>Wall: 壁裏チャージ</li><li>Stay: チャージ完了再確認</li><li>Walk: 歩き撃ち</li></ol> |
| 思考 | <ul><li>まずは状況確認。俯瞰する</li><li>[if]状況確認したら → わかったことを口に出す</li><li>[if]ラインを上げる前に → プランを口に出す</li><li>[if]SP使う前に → プランを口に出す</li><li>[if]連デスしたら → 手を止める</li></ul> |
