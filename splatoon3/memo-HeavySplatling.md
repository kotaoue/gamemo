...
1. 「射撃」を最小単位としたループを繰り返すことは、状況確認と思考を繰り返すこと

| 状況 | if-then |
| -- | -- |
| 原則 | <ol><li>状況確認 ≒ Before チャージ</li><li>[if]状況確認したら → わかったことを口に出す</li><ol><li>[if]危険を感じたら → 引く</li><li>[if]ミカタがSP使ったら → 合わせる</li><li>[if]2人有利になったら → 前に出る</li><li>[if]拮抗してるなら → 無理せず塗る</li></ol><li>[if]連デスしたら → ゆっくりと深呼吸+周囲を見る</li></ol> |
