...
| 索敵 | <ul><li>[if]対面していない時は → 注意するポイントを順番に見る<ul><li>❌️ 全部を見る。※ 無理</li><li>⭕️ 注意すべき場所を順番に見ていく<ol><li>見るべき場所を先に決めておく</li><li>危ない順に目視確認をする</li><li>確認終わったら、再度最初から確認</li></ol></ul></ul> |
