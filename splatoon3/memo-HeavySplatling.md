...
| 状況 | if-then |
| -- | -- |
| プレイ | <ul><li>[if]チャージする前に → 周りを見る</li><li>[if]チャージするなら → 壁裏</li><li>[if]チャージしたなら → 周りを見る</li><li>[if]撃つなら → 動き続ける</li><li>[if]撃ってるなら → 周りを見る</li></ul> |
| 思考 | <ol><li>状況確認 </li><li>[if]状況確認したら → わかったことを口に出す</li><li>[if]連デスしたら → ゆっくりと深呼吸+周囲を見る</li></ol> |
