...
| 状況 | if-then |
| -- | -- |
| プレイ | <ul><li>[if]チャージする前に → 状況確認</li><li>[if]チャージするなら → 壁裏</li><li>[if]チャージしたなら → 状況確認</li><li>[if]撃つなら → 動き続ける</li><li>[if]撃ってるなら → 状況確認</li></ul> |
| 思考 | <ol><li>状況確認 </li><li>[if]状況確認したら → わかったことを口に出す</li><li>[if]打開する前に → プランを口に出す</li><li>[if]連デスしたら → 手を止める</li></ol> |
