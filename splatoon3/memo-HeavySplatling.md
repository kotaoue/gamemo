...
- <img src="./images/HeavySplatling.png" width="16px" alt="バレル" /> バレルの真髄は「事前準備」
- <img src="./images/HeavySplatling.png" width="16px" alt="バレル" /> 少しずつアドバンテージを増やす
- <img src="./images/HeavySplatling.png" width="16px" alt="バレル" /> 相手の土俵で戦わずこちらの有利を押し付ける

### キホンのif-then

| 状況 | if-then |
| -- | -- |
| 原則 | <ol><li>塗る</li><li>[if]危険を感じたら → 引く</li><li>[if]ミカタがSP使ったら → 合わせる</li><li>[if]2人有利になったら → 前に出る</li><li>[if]連デスしたら → ゆっくりと深呼吸して周囲をぐるっと見る</li></ol> |
